...
Using this server you can set the option :option: ``CONFIG_UPDATEHUB_SERVER``
on the ``prj.conf`` file with your local ip address and the option :option:
``CONFIG_UPDATEHUB_CE_SERVER`` with true.
